...
<body>
    ...
    <form action="../../destino-create">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="data_de_ida" name="data_de_ida">
        </div>
        <div class="form-group">
            <label for="data_de_volta">Data de Volta:</label>
            <input type="date" class="form-control" id="data_de_volta" name="data_de_volta">
        </div>
        <div class="form-group">
            <label for="destino_da_viagem">Destino da Viagem:</label>
            <input type="text" class="form-control" id="destino_da_viagem" name="destino_da_viagem">
        </div>
        <div class="form-group">
            <label for="formas_de_pagamento">Formas de pagamento:</label>
            <input type="text" class="form-control" id="formas_de_pagamento" name="formas_de_pagamento">
        </div>
