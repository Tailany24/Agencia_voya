...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <jstl:forEach var="promocao" items="${listapromocao}" >
					<tr>
					    <td>${promocao.usuario.nome_completo}</td>
					    <td>${promocao.destino.destino_da_viagem}</td>
						<td>${promocao.descricao}</td>
						<td>${promocao.preco}</td>
						<td>
								
                            <a href="promocao-edit?id=${promocao.id_promocoes}" class="btn btn-success">Editar</a> 
                            <a href="promocao-delete?id=${promocao.id_promocoes}" class="btn btn-danger">Deletar</a>
		...
		<a href="promocao-getCreate" class="btn btn-primary">Criar</a>
	</div>
