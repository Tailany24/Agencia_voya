...
<link rel="shortcut icon" href="Imagem/Agencia_Voya__favicon.png"
	type="image/x-icon">
<title>Formulário de Promoção</title>
<link rel="stylesheet"
		...
		<nav class="navbar navbar-expand-md bg-menu">
			<div class="container-fluid">
				<a class="navbar-brand"> <img
					src="Imagem/Voya-preview.png" width="200" height="81"
				...
				<div class="collapse navbar-collapse justify-content-end"
					...
					<div class="navbar-nav ps-1 d-flex mx-auto">
						<a class="nav-link" href="index.html">Home</a> <a
							class="nav-link" href="./destino">Destino</a> <a
							class="nav-link" href="./promocao">Promoções</a> <a
							class="nav-link" href="./usuario">Usuarios</a>
					</div>
				</div>
			</div>
		</nav>
		...
		<form action="./promocao-create">
			...
			<div class="form-group mb-3">
				<label for="usuario" class="form-label"> Usuario </label> <select
					id="livro" name="usuario" class="form-control">
			...
			<div class="form-group mb-3">
				<label for="destino" class="form-label"> Destino </label> <select
					id="usuario" name="destino" class="form-control">
					<option value="DEFAULT">Escolha um  Destino </option>
					<jstl:forEach items="${listaDestino}" var="d">
						<option value="${d.id_destino}">${d.destino_da_viagem}</option>
					</jstl:forEach>
				</select>
			</div>
			...
			<button type="submit" value="Enviar" class="btn btn-primary">Salvar
				Informações</button>
		</form>
