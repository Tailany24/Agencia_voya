...
<head>
<meta charset="UTF-8">
<link rel="shortcut icon" href="Imagem/Agencia_Voya__favicon.png"
	type="image/x-icon">
	...
	<header>
		<nav class="navbar navbar-expand-md bg-menu">
			<div class="container-fluid">
				<a class="navbar-brand"> <img src="Imagem/Voya-preview.png"
					width="200" height="81" class="d-inline-block align-text-top">
				</a>
				...
				<div class="collapse navbar-collapse justify-content-end"
					...
					<div class="navbar-nav ps-1 d-flex mx-auto">
						<a class="nav-link" href="./">Home</a> <a class="nav-link"
							href="./destino">Destino</a> <a class="nav-link"
							href="./promocao">Promoções</a> <a class="nav-link"
	...
	<div class="container">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<!-- Linhas da tabela com dados do cliente -->
				<jstl:forEach items="${listausuario}" var="l">
					<tr>
						...
						<td>${l.telefone}</td>
						<td>
							<a href="usuario-edit?id=${l.id_usuario }" class="btn btn-success">Editar</a> 
							<a href="usuario-delete?id=${l.id_usuario }" class="btn btn-danger">Deletar</a>
						</td>
					</tr>
				</jstl:forEach>
			</tbody>
		</table>
		<a href="views/usuario/createusuario.html" class="btn btn-primary">Criar</a>
	</div>
